...
4. **[TinyTools](https://tinytools-smoky.vercel.app/)** - A collection of free, no-signup, browser-based web utilities for everyday productivity tasks: favicon generator, OG image generator, color palette generator, SEO meta tag generator, AI background remover (runs locally), AI cost calculator, domain name generator, and more. Open source.
